...
def get_payment_method_classes(brand, payment_methods, baseclass, settingsholder):
    ...
    return [settingsholder] + [
        type(
            f'Computop{"".join(m["public_name"].split())}', (m['baseclass'] if 'baseclass' in m else baseclass,), {
...
payment_method_classes = get_payment_method_classes('Computop', payment_methods, ComputopMethod, ComputopSettingsHolder)
